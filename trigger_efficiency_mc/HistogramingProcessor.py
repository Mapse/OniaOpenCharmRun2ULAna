...
class HistogramingProcessor(processor.ProcessorABC):
    ...
    def process(self, path):
        ...
        file = path + '/Monte_Carlo_Jpsi_25to45_Dstar_DPS_2018_13TeV.coffea'
        acc = load(file)
        ...
        save(output, path + '/Monte_Carlo_Jpsi_25to45_Dstar_DPS_2018_13TeV_hists.coffea')
...
if __name__ == '__main__':
    ...
    path_file = '/afs/cern.ch/work/m/mabarros/public/CMSSW_10_6_12/src/OniaOpenCharmRun2ULAna/output/Monte_Carlo_Jpsi_25to45_Dstar_DPS_2018_13TeV/'
   
    p = HistogramingProcessor('Trigger_plots')
