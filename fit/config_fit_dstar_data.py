...
################### OBS:!!!!!!!!!!!!!!!!!!!!!!1
# The variable mass takes the name "mass" for old ntuples and the name "deltam" for the new ones

## Variables to change

# Common use (to use with one file or several)
wspace_name = "Dstar_wspace"
wspace_root = "Dstar_nonAssociated_fit.root"
save_fit = "Dstar_nonAssociated_data_fit.png"
save_fit_log = "Dstar_nonAssociated_data_fit_log.png"
save_pull = "Dstar_nonAssociated_fit_pull.png"
...
dict_fls = {
    ...
    "save_path_single_file" : data_file_path,
    # Root file with all parameters saved by the workspace
    "wspace_root" : wspace_root,
    # Name of the figure with the fiting
    "save_fit" : save_fit,
    # Name of the figure with the fitting in log scale,
    "save_fit_log" : save_fit_log,
    "save_pull" : save_pull,
